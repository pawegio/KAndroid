...
<a href="http://www.methodscount.com/?lib=com.pawegio.kandroid%3Akandroid%3A0.6.6"><img src="https://img.shields.io/badge/Methods and size-core: 343 | 88 KB-e91e63.svg"></img></a>

# KAndroid
<img src="art/logo.png" width="160px">

Kotlin library for Android providing useful extensions to eliminate boilerplate code in Android SDK and focus on productivity. Library is currently compatible with latest **Kotlin 1.0.2** build.
...
dependencies {
    compile 'com.pawegio.kandroid:kandroid:0.6.6@aar'
}
```
