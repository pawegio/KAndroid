...
Kotlin library for Android providing useful extensions to eliminate boilerplate code in Android SDK and focus on productivity. Library is compatible with **Kotlin 1.1.4-2** build.
...
dependencies {
    compile 'com.pawegio.kandroid:kandroid:0.8.4@aar'
}
```
