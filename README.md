...
Kotlin library for Android providing useful extensions to eliminate boilerplate code in Android SDK and focus on productivity. Library is currently compatible with latest **Kotlin 1.0 Beta Candidate** build.
...
dependencies {
    compile 'com.pawegio.kandroid:kandroid:0.3.0@aar'
}
```
